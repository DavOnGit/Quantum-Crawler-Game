...
import thunk from 'redux-thunk'             // This is neded for tests with mock-store
...
describe('Actions', () => {
  ...
  it('should generate login action object', () => {
    var action = {
      type: 'LOGIN',
      uid: '3fGxc7EtiFhtZ3Y56kfEgBc6lPr1'
    }
  ...
  describe('Tests with firebase todos', () => {
    ...
    beforeEach(done => {
      ...
      NOTE: The previous auth method does seems to work anymore!!! So it's replaced by anonymous auth
      */
